...
public class CartController {
    ...
    public String addCart(@RequestParam("workingItemId") String workingItemId,HttpServletRequest request,Model model){
    ...
    public String removeCart(@RequestParam("workingItemId") String workingItemId,HttpServletRequest request,Model model){
